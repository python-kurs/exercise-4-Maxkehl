...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  3 08:44:48 2019
...
garmisch  = pd.read_csv("/home/io/Dokumente/Python Kurs/exercise-4-Maxkehl/data/produkt_klima_tag_20171010_20190412_01550.txt", sep = ";", index_col="MESS_DATUM", parse_dates=["MESS_DATUM"])
zugspitze = pd.read_csv("/home/io/Dokumente/Python Kurs/exercise-4-Maxkehl/data/produkt_klima_tag_20171010_20190412_05792.txt", sep = ";", index_col="MESS_DATUM", parse_dates=["MESS_DATUM"])
garmisch.head()
zugspitze.head()
print(garmisch)
...
def create_climate_diagram(df,
    ...
    #ax1.plot(df[temp_col],color="red",label"temperature") # invalid syntax
...
create_climate_diagram(garmisch, temp_col=" TMK", prec_col=" RSK", title="Climate Diagramm Garmisch 2018", filename= "/home/io/Dokumente/Python Kurs/exercise-4-Maxkehl/Climate_Garmisch_2018.png")

create_climate_diagram(zugspitze, temp_col=" TMK", prec_col=" RSK", title="Climate Diagramm Zugspitze 2018", filename= "/home/io/Dokumente/Python Kurs/exercise-4-Maxkehl/Climate_Zugspitze_2018.png")